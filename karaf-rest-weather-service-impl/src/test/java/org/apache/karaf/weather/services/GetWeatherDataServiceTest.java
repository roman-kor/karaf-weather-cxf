...
class GetWeatherDataServiceTest {
    ...
    @BeforeClass
    public void setUp(){
        getWeatherDataService = new GetWeatherDataService();
    }
...
//Within Canada
    ...
    public void checkValidationWeatherDataDto(String city) throws WeatherException {
        GetWeatherDataService getWeatherDataService = new GetWeatherDataService();
      WeatherDataDto weatherDataDto = getWeatherDataService.getWeatherData(city);
    ...
    public void weatherServiceCheckException(String city) {
        ...
        GetWeatherDataService getWeatherDataService = new GetWeatherDataService();
      try {
          getWeatherDataService.getWeatherData(city);
